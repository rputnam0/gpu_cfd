...
- Any future expansion of this map must preserve the milestone-1 solver family, runtime schema, and backend/default policies frozen by the authority bundle indexed in `docs/authority/README.md`.
