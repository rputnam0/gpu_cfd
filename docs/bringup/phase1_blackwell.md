...
artifacts, Nsight summary/NVTX report files, and the smoke-result and smoke-log /
Nsight-result JSON inputs used by the hard gates. The bundle index is the archive-facing
