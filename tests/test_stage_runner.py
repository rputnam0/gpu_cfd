...
class StageRunnerTests(unittest.TestCase):
    ...
    def test_emit_case_bundle_rejects_runtime_and_provenance_mismatch(self) -> None:
        bundle = load_authority_bundle(repo_root())
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            stage_plan["runtime_base"] = "OpenFOAM 12"
            stage_plan["provenance"]["manifest_refs"] = "stale/manifest_refs.json"
